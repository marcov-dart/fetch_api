...
typedef ReadableStreamSourceControllerMethodFunction<T extends JSAny,
        R extends JSAny?>
    = FutureOr<R> Function(ReadableStreamController<T> controller);

/// General interface for controller based `pull` and `start` methods.
extension type ReadableStreamSourceControllerMethod<T extends JSAny,
    R extends JSAny?>._(JSFunction _) implements JSFunction {
  ...
  factory ReadableStreamSourceControllerMethod(
    ReadableStreamSourceControllerMethodFunction<T, R> fn,
      ...
      ((ReadableStreamController<T> controller) =>
              ...
              fn(controller).toJSPromiseOr).toJS
          as ReadableStreamSourceControllerMethod<T, R>;
